                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :dots="false" :nav="false">
                                    <div class="pt" @click="changeImg(thumbs[0])" :class="thumbs[0] == gambar_default ? 'active' : ''">
                                        <img src="img/celana1.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImg(thumbs[1])" :class="thumbs[1] == gambar_default ? 'active' : ''">
                                        <img src="img/celana2.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImg(thumbs[2])" :class="thumbs[0] == gambar_default ? 'active' : ''">
                                        <img src="img/celana3.jpg" alt="" />
                                    </div>
                                </carousel>
                            </div>
                        </div>
...
export default {
  ...
  data() {
      return{
          gambar_default: "img/celana1.jpg",
          thumbs: [
              "img/celana1.jpg",
              "img/celana2.jpg",
              "img/celana3.jpg"
